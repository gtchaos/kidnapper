/**
 * @license ResponsiveVoice JS v1.4.9
 *
        ...
        self.fallback_startPart = function () {
            ...
            if (self.fallback_audio == null) {
                ...
                /*self.fallback_audio.addEventListener('error', function (e) {
                 ...
                 console.log("RV: Error playing the file (aborted)");
                 break;
                 case e.target.error.MEDIA_ERR_NETWORK:
                 console.log("RV: Error playing the file (network)");
                 break;
                 case e.target.error.MEDIA_ERR_DECODE:
                 console.log("RV: Error playing the file (decode)");
                 break;
                 case e.target.error.MEDIA_ERR_SRC_NOT_SUPPORTED:

                 console.log("RV: Error playing the file (not supported), skipping");
                 ...
                 break;
                 default:
                 console.log("RV: Error playing the file (unknown)");
                 break;
                 }                    
                 }, true);*/
